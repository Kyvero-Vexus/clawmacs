# Clawmacs — Common Lisp Agent Platform

**Clawmacs** is a free, open-source AI agent platform written in pure Common Lisp.
...
Clawmacs is designed for users who:
...
- **Full Emacs-style configuration** — one `~/.clawmacs/init.lisp`, no JSON
...
- [Deployment](deployment/index.md) — running Clawmacs as a service

## Project Status

Clawmacs is **actively developed**. All core features are implemented and tested.
...
Clawmacs is free software: you can redistribute it and/or modify it under the terms
